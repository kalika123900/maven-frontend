...
class Login extends React.Component {
  ...
  getPublicAddress = ()=> {
    ...
    torus.getPublicAddress({ verifier: selectedVerifier, verifierId }).then(this.console).catch(console.error);
  }
  ...
  stringifiableToHex = (value) => ethers.utils.hexlify(Buffer.from(JSON.stringify(value)))
